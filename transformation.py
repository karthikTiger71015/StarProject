...
spark.sparkContext.addPyFile("s3://karthikkumar-landingbucket-batch01/delta-core_2.12-1.2.0.jar")

# Define the configuration file path
config_file_path = "s3://karthikkumar-landingbucket-batch01/app.json"
...
print(filename)
deltatablepath="s3://karthikkumar-staggingbucket-batch01/deltatable/"
